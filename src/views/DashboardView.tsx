...
export default function DashboardView() {
  ...
  if (isError) return <ErrorMessage>Error al cargar los proyectos</ErrorMessage>;
    ...
    <>
      ...
      {data && data.length > 0 ? (
        ...
        <p className="text-center py-20">
          ...
          <Link
            to={"/projects/create"}
            className="text-fuchsia-500 hover:text-fuchsia-600 transition-colors font-bold underline"
          >
            Crear Proyecto
          </Link>
        </p>
